...
TESTING
program mengarahkan user untuk menginput huruf untuk ditebak, lalu jika berhasil, akan dikeluarkan tampilan "tebakan anda benar", dan kesempatan berkurang.
jika huruf yang ditebak salah, maka program tetap melanjutkan permainan. "*/
